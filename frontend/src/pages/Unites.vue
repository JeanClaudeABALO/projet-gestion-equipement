    ...
    <div class="content-wrapper">
      ...
      <div class="header-bar">
        <div class="header-content">
          ...
          <p class="subtitle">Gérez les unités de votre organisation</p>
        </div>
...
const filteredUnites = computed(() => {
  ...
  if (filters.value.departement_id) {
    list = list.filter((u) => String(u.departement_id) === String(filters.value.departement_id));
  }
...
function resetFilters() {
  filters.value = { departement_id: "", type_unite: "" };
  searchQuery.value = "";
}
...
function scrollToBottom() {
  ...
  // Mise à jour de la flèche après la fin du scroll (animation ~400ms)
